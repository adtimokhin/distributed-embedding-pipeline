...
func (x *SubmitResponse) GetRedirectAddr() string {
	if x != nil {
...
func (x *PollResponse) GetRedirectAddr() string {
	if x != nil {
		return x.RedirectAddr
	}
	return ""
...
func (x *CompleteResponse) GetRedirectAddr() string {
	if x != nil {
		return x.RedirectAddr
	}
	return ""
...
func (x *HeartbeatResponse) GetRedirectAddr() string {
	if x != nil {
		return x.RedirectAddr
	}
	return ""
...
const file_proto_broker_proto_rawDesc = "" +
	...
	"\rredirect_addr\x18\x02 \x01(\tR\fredirectAddr\"H\n" +
