...
const (
	...
	RaftRPC_InstallSnapshot_FullMethodName = "/raft.RaftRPC/InstallSnapshot"
)
...
func (UnimplementedRaftRPCServer) InstallSnapshot(context.Context, *InstallSnapshotArgs) (*InstallSnapshotReply, error) {
